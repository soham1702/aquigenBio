...
describe('RawMaterialOrder Management Component', () => {
  let comp: RawMaterialOrderComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'raw-material-order', component: RawMaterialOrderComponent }]),
      ...
      .overrideTemplate(RawMaterialOrderComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.rawMaterialOrders?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
