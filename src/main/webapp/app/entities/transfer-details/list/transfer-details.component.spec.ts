...
describe('TransferDetails Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'transfer-details', component: TransferDetailsComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.transferDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
