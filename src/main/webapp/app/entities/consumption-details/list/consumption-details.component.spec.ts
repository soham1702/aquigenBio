...
describe('ConsumptionDetails Management Component', () => {
  let comp: ConsumptionDetailsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'consumption-details', component: ConsumptionDetailsComponent }]),
      ...
      .overrideTemplate(ConsumptionDetailsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.consumptionDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
