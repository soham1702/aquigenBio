...
export class ProductTransactionComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.productTransactionService
      ...
      .subscribe({
        next: (res: HttpResponse<IProductTransaction[]>) => {
  ...
  trackId(index: number, item: IProductTransaction): number {
    return item.id!;
  }

  delete(productTransaction: IProductTransaction): void {
    const modalRef = this.modalService.open(ProductTransactionDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.productTransaction = productTransaction;
  ...
  protected onSuccess(data: IProductTransaction[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
