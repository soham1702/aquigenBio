...
describe('ProductTransaction Management Component', () => {
  let comp: ProductTransactionComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'product-transaction', component: ProductTransactionComponent }]),
      ...
      .overrideTemplate(ProductTransactionComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.productTransactions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
